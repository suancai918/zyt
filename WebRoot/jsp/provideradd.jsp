...
<div class="right">
        ...
        <div class="providerAdd">
           <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/jsp/provideradd" enctype="multipart/form-data">
			<!-- <input type="hidden" name="method" value="add"> -->
                ...
                <div>
                    <label for="proDesc">商品展示：</label>
                    <input type="file" name="proidpic" id="proidpic" value=""> 
                </div>
