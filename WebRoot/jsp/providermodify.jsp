...
<%@include file="/jsp/common/head.jsp"%>
  ...
  <div class="right">
      ...
      <div class="providerAdd">
          <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/jsp/providermodify">
			...
			<font color="red"></font>
              ...
              <div>
                  <label for="userAddress">商品展示：</label>
                  <img src="${pageContext.request.contextPath }/idpics/${provider.pidpic}">
              </div>
