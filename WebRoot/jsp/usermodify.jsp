...
<%@include file="/jsp/common/head.jsp"%>
    <div class="right">
        ...
        <form id="userForm" name="userForm" method="post" action="${pageContext.request.contextPath }/jsp/usermodify">
			<input type="hidden" name="id" value="${user.id }"/>
			 ...
			 <div>
		       ...
		       <div>
                ...
                <div>
                    <label for="userAddress">用户身份：</label>
                    <img src="${pageContext.request.contextPath }/idpics/${user.idpic}">
                </div>
